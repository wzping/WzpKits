...
package wzp.libs.function.zxing.decoding;
...
final class DecodeThread extends Thread {
    ...
    DecodeThread(CaptureFragment fragment,
        ...
        if (decodeFormats == null || decodeFormats.isEmpty()) {
            ...
            decodeFormats.addAll(DecodeFormatManager.QR_CODE_FORMATS);   ///QR_CODE即二维码
            decodeFormats.addAll(DecodeFormatManager.DATA_MATRIX_FORMATS); //也属于一种二维码
        }
