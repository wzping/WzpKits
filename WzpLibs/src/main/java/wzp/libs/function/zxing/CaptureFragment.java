...
import wzp.libs.function.zxing.decoding.CaptureActivityHandler;
import wzp.libs.function.zxing.decoding.InactivityTimer;
import wzp.libs.function.zxing.util.QrCodeUtils;
import wzp.libs.function.zxing.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    //解析回调处理
    private QrCodeUtils.AnalyzeCallback analyzeCallback;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = null;
        if (bundle != null) {
            int layoutId = bundle.getInt(QrCodeUtils.LAYOUT_ID);
            if (layoutId != -1) {
    ...
    public QrCodeUtils.AnalyzeCallback getAnalyzeCallback() {
        return analyzeCallback;
    }


    public void setAnalyzeCallback(QrCodeUtils.AnalyzeCallback analyzeCallback) {
    ...
    public void setInnerMarginTop(int marginTop){
        if (viewfinderview!=null)
            viewfinderview.setInnerMarginTop(marginTop);
    }
}
