package wzp.libs.widget.scrollview;
...
public class OverScrollView extends FrameLayout implements OnTouchListener {
	...
	/**
	 * True when the layout_autojdkuaibao has changed but the traversal has not come through
	 ...
	 * while the layout_autojdkuaibao is dirty. This prevents the scroll from being wrong if
	...
	private void initBounce() {
		...
		// init the bouncy scroller, and make sure the layout_autojdkuaibao is being drawn
