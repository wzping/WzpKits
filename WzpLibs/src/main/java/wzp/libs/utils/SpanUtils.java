...
public final class SpanUtils {
    ...
    private SpanUtils(Context mContext, TextView textView) {
        this();
...
//          mTextView.setHighlightColor(Color.TRANSPARENT); //点击跳转的时候，默认背景色会高亮，这里设置高亮为透明，这样点击的时候就不会有背景颜色了
        }
